...
*/
    ...
    var isWinChildInOption = (option, id_optionTofind) =>{
        return function () {
            /*option.id_with_win.indexOf(id_optionTofind) > -1 ? true : false;*/
            return option.id_with_win.indexOf(id_optionTofind) > -1;
        }
    };

    var isLoseChildInOption = (option, id_optionTofind) =>{
        return function () {
        /* option.id_with_lose.indexOf(id_optionTofind) > -1 ? true : false;*/
           return option.id_with_win.indexOf(id_optionTofind) > -1;
        }
    };
